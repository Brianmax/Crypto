...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s gvicoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gvicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gvicoin transaction") + "\n" +
              "  gvicoin-tx [options] -create [commands]   " + _("Create hex-encoded gvicoin transaction") + "\n" +
              "\n";
