...
{
    const char* pszTimestamp = "Seguridad en Computacion 2022-2/UCSP";
    const CScript genesisOutputScript = CScript() << ParseHex("051084710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1668529800, 2002336123, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x304a0fccb5128046410363ed75ae84122ea32b56bfd764843f66b98a3e0561c7"));
        assert(genesis.hashMerkleRoot == uint256S("0x62e82598d5556e5cd5ecee3f88bbb0d7a464a8825437a74fc02b68bfb18aeebb"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("62.210.69.92", "62.210.69.92", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("gvicointools.com", "dnsseed.gvicointools.com"));
        //vSeeds.push_back(CDNSSeedData("gvicoinpool.org", "dnsseed.gvicoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x304a0fccb5128046410363ed75ae84122ea32b56bfd764843f66b98a3e0561c7"))
        ...
        chainTxData = ChainTxData{
            ...
            1668529800, // * UNIX timestamp of last known number of transactions
...
//
        ...
        genesis = CreateGenesisBlock(1668529800, 830233, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x62e82598d5556e5cd5ecee3f88bbb0d7a464a8825437a74fc02b68bfb18aeebb"));
        assert(genesis.hashMerkleRoot == uint256S("0x5725c00c25dad50839b50d49dc6bc4c36b270d556f5a2a5df23ef2083515b7ba"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("62.210.69.92", "62.210.69.92"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.gvicoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x5725c00c25dad50839b50d49dc6bc4c36b270d556f5a2a5df23ef2083515b7ba")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1668382036, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4a93e94c7b7949733e595372728f44bc7e78b2b3639829b19f0d3a492340933f"));
        assert(genesis.hashMerkleRoot == uint256S("0x62e82598d5556e5cd5ecee3f88bbb0d7a464a8825437a74fc02b68bfb18aeebb"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x4a93e94c7b7949733e595372728f44bc7e78b2b3639829b19f0d3a492340933f"))
        };
