...
{
    const char* pszTimestamp = "Seguridad en Computacion 2022-2";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1668382036, 2001820108, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa9c6fb7ff981bb95337c973e2cf76b4676faea3da258849811fd69e32099901b"));
        assert(genesis.hashMerkleRoot == uint256S("0x6d279beb9367245f6de66dec6f0106948310bbf5ffc2e2da06503fcf03b9a178"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xa9c6fb7ff981bb95337c973e2cf76b4676faea3da258849811fd69e32099901b"))
        ...
        chainTxData = ChainTxData{
            ...
            1668382036, // * UNIX timestamp of last known number of transactions
...
//
        ...
        genesis = CreateGenesisBlock(1668382036, 2759278, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xfba6a9d664c30d5abd609896e60b7d5920e9beb6d750b4fb5576cb0bb0b184d0"));
        assert(genesis.hashMerkleRoot == uint256S("0x6d279beb9367245f6de66dec6f0106948310bbf5ffc2e2da06503fcf03b9a178"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xfba6a9d664c30d5abd609896e60b7d5920e9beb6d750b4fb5576cb0bb0b184d0")),
        };
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf95615fbaa5dca2724ceaa9c9db1337f0ea8996f8760e944f33253109510382b"));
        assert(genesis.hashMerkleRoot == uint256S("0x6d279beb9367245f6de66dec6f0106948310bbf5ffc2e2da06503fcf03b9a178"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xf95615fbaa5dca2724ceaa9c9db1337f0ea8996f8760e944f33253109510382b"))
        };
