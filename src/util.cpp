...
const char * const BITCOIN_CONF_FILENAME = "gvicoin.conf";
const char * const BITCOIN_PID_FILENAME = "gvicoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "GVicoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/GVicoin";
#else
    // Unix
    return pathRet / ".gvicoin";
#endif
#endif
}
